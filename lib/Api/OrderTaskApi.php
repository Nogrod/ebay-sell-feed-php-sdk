...
/**
     ...
     * @return void
     */
    public function createOrderTask($content_type, $create_order_task_request, string $contentType = self::contentTypes['createOrderTask'][0])
    {
     ...
     */
    public function createOrderTaskWithHttpInfo($content_type, $create_order_task_request, string $contentType = self::contentTypes['createOrderTask'][0])
    {
     ...
     */
    public function createOrderTaskAsync($content_type, $create_order_task_request, string $contentType = self::contentTypes['createOrderTask'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createOrderTaskAsyncWithHttpInfo($content_type, $create_order_task_request, string $contentType = self::contentTypes['createOrderTask'][0])
    {
        $returnType = '';
        $request = $this->createOrderTaskRequest($content_type, $create_order_task_request, $contentType);
     ...
     */
    public function createOrderTaskRequest($content_type, $create_order_task_request, string $contentType = self::contentTypes['createOrderTask'][0])
    {
