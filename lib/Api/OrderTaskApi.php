...
/**
     ...
     * @return void
     */
    public function createOrderTask($create_order_task_request, $x_ebay_c_marketplace_id = null, string $contentType = self::contentTypes['createOrderTask'][0])
    {
        $this->createOrderTaskWithHttpInfo($create_order_task_request, $x_ebay_c_marketplace_id, $contentType);
    }
     ...
     */
    public function createOrderTaskWithHttpInfo($create_order_task_request, $x_ebay_c_marketplace_id = null, string $contentType = self::contentTypes['createOrderTask'][0])
    {
        $request = $this->createOrderTaskRequest($create_order_task_request, $x_ebay_c_marketplace_id, $contentType);
     ...
     */
    public function createOrderTaskAsync($create_order_task_request, $x_ebay_c_marketplace_id = null, string $contentType = self::contentTypes['createOrderTask'][0])
    {
        return $this->createOrderTaskAsyncWithHttpInfo($create_order_task_request, $x_ebay_c_marketplace_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createOrderTaskAsyncWithHttpInfo($create_order_task_request, $x_ebay_c_marketplace_id = null, string $contentType = self::contentTypes['createOrderTask'][0])
    {
        $returnType = '';
        $request = $this->createOrderTaskRequest($create_order_task_request, $x_ebay_c_marketplace_id, $contentType);
     ...
     */
    public function createOrderTaskRequest($create_order_task_request, $x_ebay_c_marketplace_id = null, string $contentType = self::contentTypes['createOrderTask'][0])
    {
     ...
     */
    public function getOrderTask($task_id, string $contentType = self::contentTypes['getOrderTask'][0])
    {
     ...
     */
    public function getOrderTaskWithHttpInfo($task_id, string $contentType = self::contentTypes['getOrderTask'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderTaskAsync($task_id, string $contentType = self::contentTypes['getOrderTask'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderTaskAsyncWithHttpInfo($task_id, string $contentType = self::contentTypes['getOrderTask'][0])
    {
        $returnType = '\eBay\Sell\Feed\Model\OrderTask';
        $request = $this->getOrderTaskRequest($task_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrderTaskRequest($task_id, string $contentType = self::contentTypes['getOrderTask'][0])
    {
     ...
     */
    public function getOrderTasks($date_range = null, $feed_type = null, $limit = null, $look_back_days = null, $offset = null, $schedule_id = null, string $contentType = self::contentTypes['getOrderTasks'][0])
    {
     ...
     */
    public function getOrderTasksWithHttpInfo($date_range = null, $feed_type = null, $limit = null, $look_back_days = null, $offset = null, $schedule_id = null, string $contentType = self::contentTypes['getOrderTasks'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderTasksAsync($date_range = null, $feed_type = null, $limit = null, $look_back_days = null, $offset = null, $schedule_id = null, string $contentType = self::contentTypes['getOrderTasks'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderTasksAsyncWithHttpInfo($date_range = null, $feed_type = null, $limit = null, $look_back_days = null, $offset = null, $schedule_id = null, string $contentType = self::contentTypes['getOrderTasks'][0])
    {
        $returnType = '\eBay\Sell\Feed\Model\OrderTaskCollection';
        $request = $this->getOrderTasksRequest($date_range, $feed_type, $limit, $look_back_days, $offset, $schedule_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrderTasksRequest($date_range = null, $feed_type = null, $limit = null, $look_back_days = null, $offset = null, $schedule_id = null, string $contentType = self::contentTypes['getOrderTasks'][0])
    {
