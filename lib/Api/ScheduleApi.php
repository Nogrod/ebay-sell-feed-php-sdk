...
/**
     ...
     * @return object
     */
    public function createSchedule($content_type, $create_user_schedule_request, string $contentType = self::contentTypes['createSchedule'][0])
    {
     ...
     */
    public function createScheduleWithHttpInfo($content_type, $create_user_schedule_request, string $contentType = self::contentTypes['createSchedule'][0])
    {
     ...
     */
    public function createScheduleAsync($content_type, $create_user_schedule_request, string $contentType = self::contentTypes['createSchedule'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createScheduleAsyncWithHttpInfo($content_type, $create_user_schedule_request, string $contentType = self::contentTypes['createSchedule'][0])
    {
        $returnType = 'object';
        $request = $this->createScheduleRequest($content_type, $create_user_schedule_request, $contentType);
     ...
     */
    public function createScheduleRequest($content_type, $create_user_schedule_request, string $contentType = self::contentTypes['createSchedule'][0])
    {
     ...
     * @return void
     */
    public function updateSchedule($schedule_id, $content_type, $update_user_schedule_request, string $contentType = self::contentTypes['updateSchedule'][0])
    {
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateScheduleWithHttpInfo($schedule_id, $content_type, $update_user_schedule_request, string $contentType = self::contentTypes['updateSchedule'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateScheduleAsync($schedule_id, $content_type, $update_user_schedule_request, string $contentType = self::contentTypes['updateSchedule'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateScheduleAsyncWithHttpInfo($schedule_id, $content_type, $update_user_schedule_request, string $contentType = self::contentTypes['updateSchedule'][0])
    {
        $returnType = '';
        $request = $this->updateScheduleRequest($schedule_id, $content_type, $update_user_schedule_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateScheduleRequest($schedule_id, $content_type, $update_user_schedule_request, string $contentType = self::contentTypes['updateSchedule'][0])
    {
