...
/**
     ...
     * @return void
     */
    public function createCustomerServiceMetricTask($accept_language, $create_service_metrics_task_request, string $contentType = self::contentTypes['createCustomerServiceMetricTask'][0])
    {
     ...
     */
    public function createCustomerServiceMetricTaskWithHttpInfo($accept_language, $create_service_metrics_task_request, string $contentType = self::contentTypes['createCustomerServiceMetricTask'][0])
    {
     ...
     */
    public function createCustomerServiceMetricTaskAsync($accept_language, $create_service_metrics_task_request, string $contentType = self::contentTypes['createCustomerServiceMetricTask'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createCustomerServiceMetricTaskAsyncWithHttpInfo($accept_language, $create_service_metrics_task_request, string $contentType = self::contentTypes['createCustomerServiceMetricTask'][0])
    {
        $returnType = '';
        $request = $this->createCustomerServiceMetricTaskRequest($accept_language, $create_service_metrics_task_request, $contentType);
     ...
     */
    public function createCustomerServiceMetricTaskRequest($accept_language, $create_service_metrics_task_request, string $contentType = self::contentTypes['createCustomerServiceMetricTask'][0])
    {
