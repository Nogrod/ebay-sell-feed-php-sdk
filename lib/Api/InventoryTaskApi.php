...
/**
     ...
     * @return void
     */
    public function createInventoryTask($create_inventory_task_request, $x_ebay_c_marketplace_id = null, string $contentType = self::contentTypes['createInventoryTask'][0])
    {
        $this->createInventoryTaskWithHttpInfo($create_inventory_task_request, $x_ebay_c_marketplace_id, $contentType);
    }
     ...
     */
    public function createInventoryTaskWithHttpInfo($create_inventory_task_request, $x_ebay_c_marketplace_id = null, string $contentType = self::contentTypes['createInventoryTask'][0])
    {
        $request = $this->createInventoryTaskRequest($create_inventory_task_request, $x_ebay_c_marketplace_id, $contentType);
     ...
     */
    public function createInventoryTaskAsync($create_inventory_task_request, $x_ebay_c_marketplace_id = null, string $contentType = self::contentTypes['createInventoryTask'][0])
    {
        return $this->createInventoryTaskAsyncWithHttpInfo($create_inventory_task_request, $x_ebay_c_marketplace_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createInventoryTaskAsyncWithHttpInfo($create_inventory_task_request, $x_ebay_c_marketplace_id = null, string $contentType = self::contentTypes['createInventoryTask'][0])
    {
        $returnType = '';
        $request = $this->createInventoryTaskRequest($create_inventory_task_request, $x_ebay_c_marketplace_id, $contentType);
     ...
     */
    public function createInventoryTaskRequest($create_inventory_task_request, $x_ebay_c_marketplace_id = null, string $contentType = self::contentTypes['createInventoryTask'][0])
    {
