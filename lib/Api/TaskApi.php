...
/**
     ...
     * @return void
     */
    public function createTask($create_task_request, $x_ebay_c_marketplace_id = null, string $contentType = self::contentTypes['createTask'][0])
    {
        $this->createTaskWithHttpInfo($create_task_request, $x_ebay_c_marketplace_id, $contentType);
    }
     ...
     */
    public function createTaskWithHttpInfo($create_task_request, $x_ebay_c_marketplace_id = null, string $contentType = self::contentTypes['createTask'][0])
    {
        $request = $this->createTaskRequest($create_task_request, $x_ebay_c_marketplace_id, $contentType);
     ...
     */
    public function createTaskAsync($create_task_request, $x_ebay_c_marketplace_id = null, string $contentType = self::contentTypes['createTask'][0])
    {
        return $this->createTaskAsyncWithHttpInfo($create_task_request, $x_ebay_c_marketplace_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTaskAsyncWithHttpInfo($create_task_request, $x_ebay_c_marketplace_id = null, string $contentType = self::contentTypes['createTask'][0])
    {
        $returnType = '';
        $request = $this->createTaskRequest($create_task_request, $x_ebay_c_marketplace_id, $contentType);
     ...
     */
    public function createTaskRequest($create_task_request, $x_ebay_c_marketplace_id = null, string $contentType = self::contentTypes['createTask'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInputFileAsync($task_id, string $contentType = self::contentTypes['getInputFile'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getInputFileRequest($task_id, string $contentType = self::contentTypes['getInputFile'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getResultFileAsync($task_id, string $contentType = self::contentTypes['getResultFile'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getResultFileRequest($task_id, string $contentType = self::contentTypes['getResultFile'][0])
    {
     ...
     */
    public function getTasks($date_range = null, $feed_type = null, $limit = null, $look_back_days = null, $offset = null, $schedule_id = null, string $contentType = self::contentTypes['getTasks'][0])
    {
     ...
     */
    public function getTasksWithHttpInfo($date_range = null, $feed_type = null, $limit = null, $look_back_days = null, $offset = null, $schedule_id = null, string $contentType = self::contentTypes['getTasks'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTasksAsync($date_range = null, $feed_type = null, $limit = null, $look_back_days = null, $offset = null, $schedule_id = null, string $contentType = self::contentTypes['getTasks'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTasksAsyncWithHttpInfo($date_range = null, $feed_type = null, $limit = null, $look_back_days = null, $offset = null, $schedule_id = null, string $contentType = self::contentTypes['getTasks'][0])
    {
        $returnType = '\eBay\Sell\Feed\Model\TaskCollection';
        $request = $this->getTasksRequest($date_range, $feed_type, $limit, $look_back_days, $offset, $schedule_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTasksRequest($date_range = null, $feed_type = null, $limit = null, $look_back_days = null, $offset = null, $schedule_id = null, string $contentType = self::contentTypes['getTasks'][0])
    {
