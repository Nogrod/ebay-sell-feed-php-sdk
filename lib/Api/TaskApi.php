...
/**
     ...
     * @return void
     */
    public function createTask($x_ebay_c_marketplace_id, $content_type, $create_task_request, string $contentType = self::contentTypes['createTask'][0])
    {
     ...
     */
    public function createTaskWithHttpInfo($x_ebay_c_marketplace_id, $content_type, $create_task_request, string $contentType = self::contentTypes['createTask'][0])
    {
     ...
     */
    public function createTaskAsync($x_ebay_c_marketplace_id, $content_type, $create_task_request, string $contentType = self::contentTypes['createTask'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTaskAsyncWithHttpInfo($x_ebay_c_marketplace_id, $content_type, $create_task_request, string $contentType = self::contentTypes['createTask'][0])
    {
        $returnType = '';
        $request = $this->createTaskRequest($x_ebay_c_marketplace_id, $content_type, $create_task_request, $contentType);
     ...
     */
    public function createTaskRequest($x_ebay_c_marketplace_id, $content_type, $create_task_request, string $contentType = self::contentTypes['createTask'][0])
    {
