...
class OrderFilterCriteria implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     *
     * @param \eBay\Sell\Feed\Model\DateRange|null $creation_date_range The creation date range of the orders you want returned. Set the date range so it contains less than 10 days (maximum). If you do not specify a <strong>DateRange</strong>, results from the last 10 days will be returned by default.
     *
     * @return $this
     */
     ...
     *
     * @param \eBay\Sell\Feed\Model\DateRange|null $modified_date_range The modified date range of the orders you want returned. <p> <span class=\"tablenote\"><strong>Note:</strong> This container is for future use. At this time, the <strong>createOrderTask</strong> method only supports order creation date filters and not modified order date filters.</span></p>
     *
     * @return $this
     */
