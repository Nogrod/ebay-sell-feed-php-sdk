...
class DateRange implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * Sets to
     *
     * @param string|null $to The end date for the date range, which is inclusive. If the parent type is included, both the <strong>from</strong> and the <strong>to</strong> fields become conditionally required.  <br /><br /><strong>For example: </strong> <br /><br />Tasks within a range  <br /> <code>yyyy-MM-ddThh:mm:ss.SSSZ..yyyy-MM-ddThh:mm:ss.SSSZ </code> <br /><br /> Tasks created on March 31, 2021<br /> <code>2021-03-31T00:00:00.000Z..2021-03-31T00:00:00.000Z</code>
     *
     * @return $this
     */
