...
class CreateUserScheduleRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     *
     * @param int|null $preferred_trigger_day_of_month The preferred day of the month to trigger the schedule. This field can be used with <strong>preferredTriggerHour</strong> for monthly schedules. The last day of the month is used for numbers larger than the actual number of days in the month. <br /><br />This field is available as specified by the template (<strong>scheduleTemplateId</strong>). The template can specify this field as optional or required and optionally provides a default value.<br /><br /><strong>Minimum: </strong>1<br /><br /><strong>Maximum: </strong>31
     *
     * @return $this
     */
     ...
     *
     * @param string|null $preferred_trigger_hour The preferred two-digit hour of the day to trigger the schedule. <br /><br />This field is available as specified by the template (<strong>scheduleTemplateId</strong>). The template can specify this field as optional or required and optionally provides a default value.<br /><br /><strong>Format:</strong> UTC <code>hhZ</code><br /><br />For example, the following represents 11:00 am UTC: <code>11Z</code>
     *
     * @return $this
     */
     ...
     * Sets schema_version
     *
     * @param string $schema_version The schema version of a schedule.
     *
     * @return $this
     */
