...
class UserScheduleResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     *
     * @param string|null $preferred_trigger_hour The preferred two-digit hour of the day to trigger the schedule. <br /><br /><strong>Format:</strong> UTC <code>hhZ</code><br /><br />For example, the following represents 11:00 am UTC: <code>11Z</code>
     *
     * @return $this
     */
     ...
     * Sets schema_version
     *
     * @param string|null $schema_version The schema version of the <strong>feedType</strong> for the schedule.
     *
     * @return $this
     */
