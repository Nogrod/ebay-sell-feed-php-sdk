...
class InventoryTask implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'InventoryTask';
     ...
     * Sets upload_summary
     *
     * @param \eBay\Sell\Feed\Model\UploadSummary|null $upload_summary This container provides summary information on an upload feed (not applicable for download feed types).
     *
     * @return $this
     */
     ...
     *
     * @param \eBay\Sell\Feed\Model\InventoryFilterCriteria|null $filter_criteria This container is used to set the filter criteria for the ActiveInventoryReport. A seller can retrieve listings for a specified format.
     *
     * @return $this
     */
