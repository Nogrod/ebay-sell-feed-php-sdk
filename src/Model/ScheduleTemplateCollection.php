...
class ScheduleTemplateCollection implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ScheduleTemplateCollection';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('schedule_templates', $data ?? [], null);
    ...
    */
     ...
     * @return $this
     */
    public function setScheduleTemplates(?array $schedule_templates): static
    {
        if (is_null($schedule_templates)) {
            throw new InvalidArgumentException('non-nullable schedule_templates cannot be null');
        }
