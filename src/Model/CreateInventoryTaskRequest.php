...
class CreateInventoryTaskRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CreateInventoryTaskRequest';
     ...
     */
    public function getFilterCriteria(): ?\eBay\Sell\Feed\Model\InventoryFilterCriteria
    {
     ...
     *
     * @param \eBay\Sell\Feed\Model\InventoryFilterCriteria|null $filter_criteria This container allows a seller to create an ActiveInventoryReport for a single listing format.
     *
     * @return $this
     */
    public function setFilterCriteria(?\eBay\Sell\Feed\Model\InventoryFilterCriteria $filter_criteria): static
    {
     ...
     * Sets schema_version
     *
     * @param string $schema_version The version number of the inventory task to use for the <strong>feedType</strong>.<br><br><span class=\"tablenote\"><strong>Note:</strong> This field <strong>must</strong> have a value of <code>1.0</code>.</span>
     *
     * @return $this
     */
