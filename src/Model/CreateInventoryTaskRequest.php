...
class CreateInventoryTaskRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets schema_version
     *
     * @param string|null $schema_version The version number of the inventory task to use for the <b>feedType</b>.<br><br><span class=\"tablenote\"><b>Note:</b> This field <b>must</b> have a value of <code>1.0</code>.</span>
     *
     * @return $this
     */
