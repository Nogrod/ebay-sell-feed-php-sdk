...
class CustomerServiceMetricsFilterCriteria implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CustomerServiceMetricsFilterCriteria';
    ...
    protected static array $openAPINullables = [
        'customer_service_metric_type' => false,
        'evaluation_marketplace_id' => false,
    ...
    {
        $this->setIfExists('customer_service_metric_type', $data ?? [], null);
        $this->setIfExists('evaluation_marketplace_id', $data ?? [], null);
        $this->setIfExists('listing_categories', $data ?? [], null);
    ...
    */
     ...
     * @return string[]|null
     */
    public function getListingCategories(): ?array
    {
     ...
     * @return $this
     */
    public function setListingCategories(?array $listing_categories): static
    {
        if (is_null($listing_categories)) {
            throw new InvalidArgumentException('non-nullable listing_categories cannot be null');
        }
     ...
     * @return $this
     */
    public function setShippingRegions(?array $shipping_regions): static
    {
