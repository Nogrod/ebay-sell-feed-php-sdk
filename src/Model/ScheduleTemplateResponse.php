...
class ScheduleTemplateResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * Sets feed_type
     *
     * @param string|null $feed_type The feed type of the schedule template. <p> <span class=\"tablenote\"><strong>Note:</strong> When calling <strong>createSchedule</strong> and <strong>updateSchedule</strong> methods, you must match the feed type specified by the schedule template (this <strong>feedType</strong>).</span></p>
     *
     * @return $this
     */
