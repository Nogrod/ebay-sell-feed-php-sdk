...
class ServiceMetricsTask implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ServiceMetricsTask';
     ...
     *
     * @param \eBay\Sell\Feed\Model\CustomerServiceMetricsFilterCriteria|null $filter_criteria This container shows the criteria set for the report.
     *
     * @return $this
     */
     ...
     * Sets schema_version
     *
     * @param string|null $schema_version The schema version number of the file format. If omitted, the default value is used. <p><strong>Default value: </strong><code>1.0</code><p>
     *
     * @return $this
     */
