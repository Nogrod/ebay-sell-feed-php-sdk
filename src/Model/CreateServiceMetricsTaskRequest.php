...
class CreateServiceMetricsTaskRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets feed_type
     *
     * @param string|null $feed_type The <strong>feedType</strong> specified for the customer service metric task being created. The report lists the transaction details that contribute to the service metrics evaluation. Supported types include:<p><code>CUSTOMER_SERVICE_METRICS_REPORT</code></p>
     *
     * @return $this
     */
     ...
     * Sets schema_version
     *
     * @param string|null $schema_version The version number of the customer service metric.<br><br><span class=\"tablenote\"><b>Note:</b> This field <b>must</b> have a value of <code>1.0</code>.</span>
     *
     * @return $this
     */
