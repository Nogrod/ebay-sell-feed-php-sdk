...
class CreateServiceMetricsTaskRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CreateServiceMetricsTaskRequest';
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['filter_criteria'] === null) {
            $invalidProperties[] = "'filter_criteria' can't be null";
        }
     ...
     * Sets feed_type
     *
     * @param string $feed_type The <strong>feedType</strong> specified for the customer service metric task being created. The report lists the transaction details that contribute to the service metrics evaluation. Supported types include:<p><code>CUSTOMER_SERVICE_METRICS_REPORT</code></p>
     *
     * @return $this
     */
     ...
     *
     * @return \eBay\Sell\Feed\Model\CustomerServiceMetricsFilterCriteria
     */
    public function getFilterCriteria(): \eBay\Sell\Feed\Model\CustomerServiceMetricsFilterCriteria
    {
     ...
     *
     * @param \eBay\Sell\Feed\Model\CustomerServiceMetricsFilterCriteria $filter_criteria This container is used to customize and set criteria for the Customer Service Metric report that will be associated with the task.
     *
     * @return $this
     */
    public function setFilterCriteria(\eBay\Sell\Feed\Model\CustomerServiceMetricsFilterCriteria $filter_criteria): static
    {
     ...
     * Sets schema_version
     *
     * @param string $schema_version The version number of the customer service metric.<br><br><span class=\"tablenote\"><strong>Note:</strong> This field <strong>must</strong> have a value of <code>1.0</code>.</span>
     *
     * @return $this
     */
