...
class OrderTask implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'OrderTask';
     ...
     *
     * @param \eBay\Sell\Feed\Model\OrderFilterCriteria|null $filter_criteria A container that returns the filter criteria used.
     *
     * @return $this
     */
