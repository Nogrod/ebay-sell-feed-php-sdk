...
class InventoryFilterCriteria implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'InventoryFilterCriteria';
    ...
    {
        $this->setIfExists('listing_format', $data ?? [], null);
    }
