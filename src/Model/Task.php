...
class Task implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * Sets detail_href
     *
     * @param string|null $detail_href The path to the call URI used to retrieve the task. This field points to the <strong>GetOrderTask</strong> URI if the task is for <code>LMS_ORDER_REPORT</code>, or it will be null if this task is for <code>LMS_ORDER_ACK</code>.
     *
     * @return $this
     */
