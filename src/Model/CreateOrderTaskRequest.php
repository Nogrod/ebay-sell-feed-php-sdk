...
class CreateOrderTaskRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'CreateOrderTaskRequest';
     ...
     * Sets feed_type
     *
     * @param string $feed_type The feed type associated with the task. The only presently supported value is <code>LMS_ORDER_REPORT</code>.<br><br>See <a href=\"/api-docs/sell/static/feed/lms-feeds-quick-reference.html#merchant-data-reports-download-feed-types\" target=\"_blank\">Report download feed types</a> for more information.
     *
     * @return $this
     */
     ...
     */
    public function getFilterCriteria(): ?\eBay\Sell\Feed\Model\OrderFilterCriteria
    {
     ...
     *
     * @param \eBay\Sell\Feed\Model\OrderFilterCriteria|null $filter_criteria The container for the filter fields. This container is used to set the filter criteria for the order report. A seller can set date range filters and/or can retrieve orders in a specific state.
     *
     * @return $this
     */
    public function setFilterCriteria(?\eBay\Sell\Feed\Model\OrderFilterCriteria $filter_criteria): static
    {
