...
class InventoryTaskApi
{
    ...
    public function createInventoryTask(
        ...
        list($response) = $this->createInventoryTaskWithHttpInfo($create_inventory_task_request, $contentType);
        return $response;
    }
    ...
    public function createInventoryTaskRequest(
        ...
        if (isset($create_inventory_task_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($create_inventory_task_request), JSON_THROW_ON_ERROR);
     ...
     *
     * @param  string $task_id This path parameter is the unique identifier of the inventory task being retrieved.&lt;br&gt;&lt;br&gt; Use the &lt;strong&gt;getInventoryTasks&lt;/strong&gt; method to retrieve inventory task IDs. (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \eBay\Sell\Feed\Model\InventoryTask|\eBay\Sell\Feed\Model\Error
     */
    public function getInventoryTask(
        string $task_id,
        string $contentType = self::contentTypes['getInventoryTask'][0]
    ): \eBay\Sell\Feed\Model\InventoryTask|\eBay\Sell\Feed\Model\Error {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \eBay\Sell\Feed\Model\InventoryTask|\eBay\Sell\Feed\Model\Error, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
     ...
     *
     * @param  string $feed_type The feed type associated with the inventory tasks being retrieved. Presently, only one feed type is available:&lt;br&gt;&lt;ul&gt;&lt;li&gt;&lt;code&gt;LMS_ACTIVE_INVENTORY_REPORT&lt;/code&gt;&lt;/li&gt;&lt;/ul&gt;See &lt;a href&#x3D;\&quot;/api-docs/sell/static/feed/lms-feeds-quick-reference.html#merchant-data-reports-download-feed-types\&quot; target&#x3D;\&quot;_blank\&quot;&gt;Report value feed types&lt;/a&gt; for more information. (required)
     * @param  string|null $schedule_id &lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;strong&gt;Note:&lt;/strong&gt; Schedule functionality for ActiveInventoryReport is currently unavailable, so this field is not usable.&lt;/span&gt; (optional)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \eBay\Sell\Feed\Model\InventoryTaskCollection|\eBay\Sell\Feed\Model\Error
     */
    ...
    ): \eBay\Sell\Feed\Model\InventoryTaskCollection|\eBay\Sell\Feed\Model\Error {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \eBay\Sell\Feed\Model\InventoryTaskCollection|\eBay\Sell\Feed\Model\Error, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
    ...
    public function getInventoryTasksRequest(
        ...
        if ($feed_type === null || (is_array($feed_type) && count($feed_type) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $feed_type when calling getInventoryTasks'
            );
        }
