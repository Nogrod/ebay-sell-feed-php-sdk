...
class OrderTaskApi
{
    ...
    public function createOrderTask(
        ...
        list($response) = $this->createOrderTaskWithHttpInfo($create_order_task_request, $contentType);
        return $response;
    }
    ...
    public function createOrderTaskRequest(
        ...
        if (isset($create_order_task_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($create_order_task_request), JSON_THROW_ON_ERROR);
     ...
     *
     * @param  string $task_id This path parameter is the unique identifier of the order task being retrieved.&lt;br&gt;&lt;br&gt;Use the &lt;a href&#x3D;\&quot;/develop/api/sell/feed_api#sell-feed_api-inventory_task-getinventorytasks\&quot; target&#x3D;\&quot;_blank\&quot;&gt;getOrderTasks&lt;/a&gt; method to retrieve order task IDs. (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \eBay\Sell\Feed\Model\OrderTask|\eBay\Sell\Feed\Model\Error
     */
    public function getOrderTask(
        string $task_id,
        string $contentType = self::contentTypes['getOrderTask'][0]
    ): \eBay\Sell\Feed\Model\OrderTask|\eBay\Sell\Feed\Model\Error {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \eBay\Sell\Feed\Model\OrderTask|\eBay\Sell\Feed\Model\Error, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
     ...
     * @param  int|null $look_back_days The number of previous days in which to search for tasks. Do not use with the &lt;strong&gt;date_range&lt;/strong&gt; parameter. If both &lt;strong&gt;date_range&lt;/strong&gt; and &lt;strong&gt;look_back_days&lt;/strong&gt; are omitted, this parameter&#39;s default value is used.  &lt;br /&gt;&lt;br /&gt;&lt;strong&gt;Default: &lt;/strong&gt; 7 &lt;br /&gt;&lt;br /&gt;&lt;strong&gt;Range: &lt;/strong&gt; 1-90 (inclusive) (optional)
     ...
     * @param  int|null $limit The maximum number of order tasks that can be returned on each page of the paginated response. Use this parameter in conjunction with the &lt;strong&gt;offset&lt;/strong&gt; parameter to control the pagination of the output. &lt;p&gt; &lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;strong&gt;Note:&lt;/strong&gt; This feature employs a zero-based list, where the first item in the list has an offset of &lt;code&gt;0&lt;/code&gt;.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;For example, if &lt;strong&gt;offset&lt;/strong&gt; is set to 10 and &lt;strong&gt;limit&lt;/strong&gt; is set to 10, the call retrieves order tasks 11 thru 20 from the result set.&lt;/p&gt;&lt;p&gt;If this parameter is omitted, the default value is used.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Default:&lt;/strong&gt; 10 &lt;p&gt;&lt;strong&gt;Maximum:&lt;/strong&gt; 500&lt;/p&gt; (optional, default to 10)
     * @param  int|null $offset The number of order tasks to skip in the result set before returning the first order in the paginated response. &lt;p&gt;Combine &lt;strong&gt;offset&lt;/strong&gt; with the &lt;strong&gt;limit&lt;/strong&gt; query parameter to control the items returned in the response. For example, if you supply an &lt;strong&gt;offset&lt;/strong&gt; of &lt;code&gt;0&lt;/code&gt; and a &lt;strong&gt;limit&lt;/strong&gt; of &lt;code&gt;10&lt;/code&gt;, the first page of the response contains the first 10 items from the complete list of items retrieved by the call. If &lt;strong&gt;offset&lt;/strong&gt; is &lt;code&gt;10&lt;/code&gt; and &lt;strong&gt;limit&lt;/strong&gt; is &lt;code&gt;20&lt;/code&gt;, the first page of the response contains items 11-30 from the complete result set. If this query parameter is not set, the default value is used and the first page of records is returned.&lt;br /&gt;&lt;br /&gt;&lt;strong&gt;Default: &lt;/strong&gt;0 (optional, default to 0)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \eBay\Sell\Feed\Model\OrderTaskCollection|\eBay\Sell\Feed\Model\Error
     */
    ...
    ): \eBay\Sell\Feed\Model\OrderTaskCollection|\eBay\Sell\Feed\Model\Error {
        list($response) = $this->getOrderTasksWithHttpInfo($feed_type, $schedule_id, $look_back_days, $date_range, $limit, $offset, $contentType);
        return $response;
    }
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \eBay\Sell\Feed\Model\OrderTaskCollection|\eBay\Sell\Feed\Model\Error, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
    public function getOrderTasksWithHttpInfo(
        ...
        $request = $this->getOrderTasksRequest($feed_type, $schedule_id, $look_back_days, $date_range, $limit, $offset, $contentType);
    ...
    public function getOrderTasksAsync(
        ...
        return $this->getOrderTasksAsyncWithHttpInfo($feed_type, $schedule_id, $look_back_days, $date_range, $limit, $offset, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
