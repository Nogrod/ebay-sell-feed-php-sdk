...
class ScheduleApi
{
    ...
    public function createScheduleRequest(
        ...
        if (isset($create_user_schedule_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($create_user_schedule_request), JSON_THROW_ON_ERROR);
     ...
     *
     * @param  string $schedule_id This path parameter is the unique identifier of the schedule being deleted.&lt;br&gt;&lt;br&gt;Use the &lt;a href&#x3D;\&quot;/develop/api/sell/feed_api#sell-feed_api-schedule-getschedules\&quot; target&#x3D;\&quot;_blank \&quot;&gt;getSchedules&lt;/a&gt; method to retrieve schedule IDs. (required)
    ...
    public function deleteSchedule(
        ...
        list($response) = $this->deleteScheduleWithHttpInfo($schedule_id, $contentType);
        return $response;
    }
     ...
     *
     * @param  string $schedule_id This path parameter is the unique identifier of the schedule for which to retrieve the latest Order Report. &lt;br&gt;&lt;br&gt; Use the &lt;a href&#x3D;\&quot;/develop/api/sell/feed_api#sell-feed_api-schedule-getschedules\&quot; target&#x3D;\&quot;_blank \&quot;&gt;getSchedules&lt;/a&gt; method to retrieve schedule IDs. (required)
     ...
     *
     * @param  string $schedule_id This path parameter is the unique identifier of the schedule for which to retrieve details.&lt;br&gt;&lt;br&gt; Use the &lt;a href&#x3D;\&quot;/develop/api/sell/feed_api#sell-feed_api-schedule-getschedules\&quot; target&#x3D;\&quot;_blank \&quot;&gt;getSchedules&lt;/a&gt; method to retrieve schedule IDs. (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \eBay\Sell\Feed\Model\UserScheduleResponse|\eBay\Sell\Feed\Model\Error
     */
    public function getSchedule(
        string $schedule_id,
        string $contentType = self::contentTypes['getSchedule'][0]
    ): \eBay\Sell\Feed\Model\UserScheduleResponse|\eBay\Sell\Feed\Model\Error {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \eBay\Sell\Feed\Model\UserScheduleResponse|\eBay\Sell\Feed\Model\Error, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
     ...
     *
     * @param  string $feed_type The feed type associated with the schedules being retrieved.&lt;br&gt;&lt;br&gt;&lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;strong&gt;Note:&lt;/strong&gt; Schedules are currently only available for &lt;code&gt;LMS_ORDER_REPORT&lt;/code&gt;.&lt;/span&gt; (required)
     * @param  int|null $limit The maximum number of schedules that can be returned on each page of the paginated response. Use this parameter in conjunction with the &lt;strong&gt;offset&lt;/strong&gt; parameter to control the pagination of the output. &lt;p&gt; &lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;strong&gt;Note:&lt;/strong&gt; This feature employs a zero-based list, where the first item in the list has an offset of &lt;code&gt;0&lt;/code&gt;.&lt;/span&gt;&lt;/p&gt;&lt;p&gt;For example, if &lt;strong&gt;offset&lt;/strong&gt; is set to 10 and &lt;strong&gt;limit&lt;/strong&gt; is set to 10, the call retrieves schedules 11 thru 20 from the result set.&lt;/p&gt;&lt;p&gt;If this parameter is omitted, the default value is used. &lt;br /&gt;&lt;br /&gt;&lt;strong&gt;Default: &lt;/strong&gt; 10 &lt;br /&gt;&lt;br /&gt;&lt;strong&gt;Maximum: &lt;/strong&gt;500 (optional, default to 10)
     * @param  int|null $offset The number of schedules to skip in the result set before returning the first schedule in the paginated response. &lt;p&gt;Combine &lt;strong&gt;offset&lt;/strong&gt; with the &lt;strong&gt;limit&lt;/strong&gt; query parameter to control the items returned in the response. For example, if you supply an &lt;strong&gt;offset&lt;/strong&gt; of &lt;code&gt;0&lt;/code&gt; and a &lt;strong&gt;limit&lt;/strong&gt; of &lt;code&gt;10&lt;/code&gt;, the first page of the response contains the first 10 items from the complete list of items retrieved by the call. If &lt;strong&gt;offset&lt;/strong&gt; is &lt;code&gt;10&lt;/code&gt; and &lt;strong&gt;limit&lt;/strong&gt; is &lt;code&gt;20&lt;/code&gt;, the first page of the response contains items 11-30 from the complete result set. If this query parameter is not set, the default value is used and the first page of records is returned.&lt;br /&gt;&lt;br /&gt;&lt;strong&gt;Default: &lt;/strong&gt;0 (optional, default to 0)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \eBay\Sell\Feed\Model\UserScheduleCollection|\eBay\Sell\Feed\Model\Error
     */
    ...
    ): \eBay\Sell\Feed\Model\UserScheduleCollection|\eBay\Sell\Feed\Model\Error {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \eBay\Sell\Feed\Model\UserScheduleCollection|\eBay\Sell\Feed\Model\Error, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
     ...
     *
     * @param  string $schedule_id This path parameter is the unique identifier of the schedule being updated. &lt;br&gt;&lt;br&gt; Use the &lt;a href&#x3D;\&quot;/develop/api/sell/feed_api#sell-feed_api-schedule-getschedules\&quot; target&#x3D;\&quot;_blank \&quot;&gt;getSchedules&lt;/a&gt; method to retrieve schedule IDs. (required)
    ...
    public function updateSchedule(
        ...
        list($response) = $this->updateScheduleWithHttpInfo($schedule_id, $update_user_schedule_request, $contentType);
        return $response;
    }
    ...
    public function updateScheduleRequest(
        ...
        if (isset($update_user_schedule_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($update_user_schedule_request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
