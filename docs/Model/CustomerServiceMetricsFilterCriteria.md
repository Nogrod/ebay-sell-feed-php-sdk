...
------------ | ------------- | ------------- | -------------
**customer_service_metric_type** | [**\eBay\Sell\Feed\Model\CustomerServiceMetricTypeEnum**](CustomerServiceMetricTypeEnum.md) | An enumeration value that specifies the customer service metric that eBay tracks to measure seller performance. | [optional]
**evaluation_marketplace_id** | [**\eBay\Sell\Feed\Model\MarketplaceIdEnum**](MarketplaceIdEnum.md) | An enumeration value that specifies the eBay marketplace where the evaluation occurs. | [optional]
