...
**order_status** | [**\eBay\Sell\Feed\Model\OrderStatusEnum**](OrderStatusEnum.md) | The order status of the orders returned. If the filter is omitted from the &lt;strong&gt;createOrderTask&lt;/strong&gt; call, orders that are in both &lt;code&gt;ACTIVE&lt;/code&gt; and &lt;code&gt;COMPLETED&lt;/code&gt; states are returned. | [optional]
